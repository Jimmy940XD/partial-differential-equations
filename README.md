...
optimal $\delta t^{\tilde}$ values: at 0.03 and above, the algorithm diverges. Up to 0.025, the algorithm converges. The limiting point must be somewhere between 0.03 and 0.025.
